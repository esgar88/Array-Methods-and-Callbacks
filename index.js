...
const homeNameFinals2014 = fifaData.filter(function (item) {
	return item.Year === 2014 && item["Home Team Name"] === "Name";
});
console.log(homeNameFinals2014);
//(a) Home Team name for 2014 world cup final
const awayNameFinals2014 = fifaData.filter(function (item) {
	return item.Year === 2014 && item["Home Team Name"] === "Name";
});
console.log(awayNameFinals2014);
//(b) Away Team name for 2014 world cup final
const homeTeamGoals2014 = fifaData.filter(function (item) {
	return item.year === 2014 && item["Home Team Goals"] === "Golas";
});
console.log(homeTeamGoals2014);
//(c) Home Team goals for 2014 world cup final
const awayTeamGoals2014 = fifaData.filter(function (item) {
	return item.Year === 2014 && item["Away Team Goals"] === "Goals";
});
console.log(awayTeamGoals2014);
//(d) Away Team goals for 2014 world cup final
const winner2014 = fifaData.filter(function (item) {
	return item.Year === 2014 && item["Win conditions"] === "Win";
});
